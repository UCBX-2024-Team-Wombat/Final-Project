...
const resolvers = {
  ...
  Mutation: {
    ...
    addSkillRelationship: async (parent, { skill, yearsOfExperience, areasOfExperience }) => {
      //creates a skill relationship and adds the skill, years of experience and areas of experience
      const skillRelationship = await SkillRelationship.create({ skill, yearsOfExperience, areasOfExperience });
